...
class FreelancerController extends Controller
{
    ...
    public function index()
    {
        ...
        $freelancers = Freelancer::where('status', 'unactive')->orderByDesc('updated_at')->get();
    ...
    public function edit($id)
    {
        ...
        $categories = Category::all();
        $images = Freelancer_id::where('user_id', $freelancer->user_id)->get();
        return view('admin.freelancers.edit', compact('freelancer', 'categories', 'images'));
    }
    ...
    {
        $categories = Category::all();
        return view('admin.freelancers.create', compact('categories'));
    } */
...
*/
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.freelancers.index')->with('msg', 'Freelancer updated successfully')->with('type', 'success');
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.freelancers.index')->with('msg', 'Freelancer deleted successfully')->with('type', 'danger');
    }
}
